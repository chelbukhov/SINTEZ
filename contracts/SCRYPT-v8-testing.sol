// текущая версия - 8 тестовая. уменьшены объемы!!!!, добавлены тестовые ф-ции (в конце кода)
...
// доработана логика подсчета проданных токенов, включены токены, раздаваемые собственником
// CRYPT Token = > CRYPT
// CRTT => CRT
